...
excerpt: Why ordinary-looking emails, comments, and diagrams can hijack LLMs
...
Indirect prompt injection is moving fast. Every week, [new exploits are published](https://embracethered.com/blog/posts/2025/announcement-the-month-of-ai-bugs/) that show it’s not a one-off trick but a repeatable attack. To a human, the data looks harmless. To the model, it looks like instructions from a trusted source.
...
## Why some prompt injections succeed while others fade
